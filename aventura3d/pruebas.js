...
/* 9) el submarino: baja al fondo, no se puede bajar del vehículo hundido, y encuentra el cofre */
{
  ...
  const ruta = [[-495,300],[-760,0],[-880,-330],[-870,-520],[-820,-700],[-720,-840],[-420,-830],[N.COFRE.x, N.COFRE.z]];   /* rodeando la ciudad grande, las torres petroleras y la islita del castillo */   /* bordeando Maracaibo y la islita del castillo */ let paso_ = 0;
